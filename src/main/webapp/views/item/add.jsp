            ...
            <div id="container">
                <form id="add_form" class="form-horizontal well">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="number" name="category_id" class="form-control" id="category_id" placeholder="Enter category">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="number" name="item_cnt" class="form-control" id="item_cnt" placeholder="Enter price">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="item_content">상품설명:</label>
                        <div class="col-sm-10">
                            <input type="text" name="item_content" class="form-control" id="item_content" placeholder="Enter name">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="flower_color">색상:</label>
                        <div class="col-sm-10">
                            <input type="text" name="flower_color" class="form-control" id="flower_color" placeholder="Enter name">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="flower_type">종류:</label>
                        <div class="col-sm-10">
                            <input type="number" name="flower_type" class="form-control" id="flower_type" placeholder="Enter price">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="flower_size">사이즈:</label>
                        <div class="col-sm-10">
                            <input type="text" name="flower_size" class="form-control" id="flower_size" placeholder="Enter name">
                        </div>
                    </div>
