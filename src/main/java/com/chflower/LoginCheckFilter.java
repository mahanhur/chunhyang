...
//    private static final String[] whitelist = {"/ws","/mailConfirm","/saveimg/","/saveimg","/faceloginimpl","/facelogin","/admin/registerimpl","/admin/register","/admin/login","/admin/loginimpl","/admin/logoutimpl","/css/*","/js/*","/webjars/*"};
//
//    @Override
